...
import { 
  Globe, Building2, FileText, Shield, Save, Globe2, Mail, Phone, MapPin, 
  RefreshCcw, ShieldCheck, DollarSign, Loader2, Check, Search, List as ListIcon, Calendar as CalendarIcon, Upload, Trash, Users as UsersIcon, Shield as ShieldIcon
} from 'lucide-react';
                  ...
                  <h3 style={{ fontSize: '1rem', fontWeight: 800, marginBottom: '0.5rem' }}>IMPUESTOS Y DIVISAS</h3>
                   <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                      ...
                      <input 
                        ...
                        value={config?.iva || 0} onChange={e => setConfig({ ...config, iva: parseFloat(e.target.value) })}
                      />
                   </div>
                   <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                      ...
                      <div style={{ position: 'relative' }}>
                         <input 
                           ...
                           value={config?.trm_actual || 0} onChange={e => setConfig({ ...config, trm_actual: parseFloat(e.target.value) })}
                         />
                              ...
                              <td style={{ padding: '1.25rem 1rem' }}>
                                 <span style={{ 
                                   ...
                                   display: 'inline-flex', alignItems: 'center', gap: '0.4rem'
                                    ...
                                    <ShieldIcon size={10} /> {(p.rol || 'VENDEDOR').toUpperCase()}
                                 </span>
                              </td>
