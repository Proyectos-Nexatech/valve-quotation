    ...
    <section id="portafolio" style={{
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '4rem' }}>
          ...
          {/* 2. Válvulas de Seguridad y Alivio */}
          <div style={{ display: 'grid', gridTemplateColumns: '80px 1fr', gap: '2rem' }}>
            <div style={{ color: 'var(--color-maroon)', backgroundColor: 'white', padding: '1rem', borderRadius: '4px', height: 'fit-content', boxShadow: 'var(--shadow-sm)' }}>
            ...
            <div>
              <h3 style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--color-slate-800)', marginBottom: '1rem', textTransform: 'uppercase' }}>
                2. Válvulas de Seguridad y Alivio (PSV / PRV)
              </h3>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                <div>
                  <h4 style={{ fontSize: '0.9rem', fontWeight: 700, color: 'var(--color-slate-700)', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Alcance:</h4>
                  <p style={{ color: 'var(--color-slate-600)', fontSize: '0.95rem' }}>Desmantelamiento total, inspección de boquillas y discos, rectificado de asientos (lapping) con planitud de bandas de luz.</p>
                </div>
                <div>
                  <h4 style={{ fontSize: '0.9rem', fontWeight: 700, color: 'var(--color-slate-700)', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Normativa Aplicable:</h4>
                  <ul style={{ color: 'var(--color-slate-600)', fontSize: '0.9rem', listStyle: 'none', padding: 0 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '80px 1fr', gap: '2rem' }}>
            ...
            <div>
              <h3 style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--color-slate-800)', marginBottom: '1rem', textTransform: 'uppercase' }}>
                3. Válvulas On/Off (Actuadas de Bloqueo)
              </h3>
              <p style={{ fontWeight: 600, color: 'var(--color-maroon)', marginBottom: '1rem' }}>Garantía de cierre hermético y respuesta rápida (ESD).</p>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                <div>
                  <h4 style={{ fontSize: '0.9rem', fontWeight: 700, color: 'var(--color-slate-700)', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Alcance:</h4>
                  <p style={{ color: 'var(--color-slate-600)', fontSize: '0.95rem' }}>Mantenimiento de actuadores neumáticos/eléctricos, tiempo de respuesta y torque.</p>
                </div>
                <div>
                  <h4 style={{ fontSize: '0.9rem', fontWeight: 700, color: 'var(--color-slate-700)', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Normativa Aplicable:</h4>
                  <ul style={{ color: 'var(--color-slate-600)', fontSize: '0.9rem', listStyle: 'none', padding: 0 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '80px 1fr', gap: '2rem' }}>
            ...
            <div>
              <h3 style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--color-slate-800)', marginBottom: '1rem', textTransform: 'uppercase' }}>
                4. Válvulas de Control (Modulantes)
              </h3>
              <p style={{ fontWeight: 600, color: 'var(--color-maroon)', marginBottom: '1rem' }}>Optimización del lazo de control y precisión en el flujo.</p>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                <div>
                  <h4 style={{ fontSize: '0.9rem', fontWeight: 700, color: 'var(--color-slate-700)', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Alcance:</h4>
                  <p style={{ color: 'var(--color-slate-600)', fontSize: '0.95rem' }}>Revisión de internos (Trim), diagnóstico de posicionadores inteligentes y reemplazo de actuadores.</p>
                </div>
                <div>
                  <h4 style={{ fontSize: '0.9rem', fontWeight: 700, color: 'var(--color-slate-700)', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Normativa Aplicable:</h4>
                  <ul style={{ color: 'var(--color-slate-600)', fontSize: '0.9rem', listStyle: 'none', padding: 0 }}>
              ...
              <p style={{ marginTop: '1rem', padding: '0.75rem', backgroundColor: '#FFF5F5', borderLeft: '3px solid var(--color-red-bright)', fontSize: '0.9rem', color: 'var(--color-maroon)', fontWeight: 600 }}>
                Pruebas: Calibración de carrera (stroke), linealidad e histéresis.
              </p>
            </div>
          </div>

          {/* 5. Válvulas de Presión y Vacío */}
          <div style={{ display: 'grid', gridTemplateColumns: '80px 1fr', gap: '2rem' }}>
            <div style={{ color: 'var(--color-maroon)', backgroundColor: 'white', padding: '1rem', borderRadius: '4px', height: 'fit-content', boxShadow: 'var(--shadow-sm)' }}>
            ...
            <div>
              <h3 style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--color-slate-800)', marginBottom: '1rem', textTransform: 'uppercase' }}>
                5. Válvulas de Presión y Vacío (Venteo / Arresto de Flama)
              </h3>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                <div>
                  <h4 style={{ fontSize: '0.9rem', fontWeight: 700, color: 'var(--color-slate-700)', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Alcance:</h4>
                  <p style={{ color: 'var(--color-slate-600)', fontSize: '0.95rem' }}>Inspección de paletas, limpieza de mallas arrestadoras de flama, verificación de sellos de diafragma y calibración de pesos.</p>
                </div>
                <div>
                  <h4 style={{ fontSize: '0.9rem', fontWeight: 700, color: 'var(--color-slate-700)', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Normativa Aplicable:</h4>
                  <ul style={{ color: 'var(--color-slate-600)', fontSize: '0.9rem', listStyle: 'none', padding: 0 }}>
